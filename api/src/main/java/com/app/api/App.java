...
public class App {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(carService.getCarsWithHigherMileage(1600));
        ...
        System.out.println(carService.getCarsWithPriceInRange(new BigDecimal("140"), new BigDecimal("170")));
        System.out.println(carService.getComponentsWithCars());
        System.out.println(carService.getCarsWithSortedComponents());
        carService.printMileageStatistics();
        carService.printPriceStatistics();
